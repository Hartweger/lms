...
const LESSON_SECTIONS: Record<number, { sections: unknown[] }> = {
  ...
  26: {
    sections: [
      ...
      {
        type: "spoiler",
        title: "Aufgaben — Wer sagt was? (a) Moderatorin, (b) Lena, (c) Simon",
        items: [
          { question: "0. Es wird Rücksicht auf die Interessen der Zuhörer genommen.", answer: "a — Moderatorin (Beispiel)" },
          { question: "23. Die Entfernung zwischen den Wohnorten spielt am Anfang eine Rolle.", answer: "b — Lena" },
          { question: "24. Der Umzug findet aus beruflichen Gründen statt.", answer: "c — Simon" },
          { question: "25. Einen neuen Liebespartner findet man nicht so schnell.", answer: "b — Lena" },
          { question: "26. Kommunikationstechnologie bietet keine wahre Chance, eine Beziehung fortzusetzen.", answer: "c — Simon" },
          { question: "27. Bei Problemen sollte man sich nicht nur auf die Nachteile einer Situation konzentrieren.", answer: "a — Moderatorin" },
          { question: "28. Auf dem Land gibt es nicht viele Unterhaltungsmöglichkeiten.", answer: "b — Lena" },
          { question: "29. Im Dorf bleibt nichts geheim.", answer: "a — Moderatorin" },
          { question: "30. Man sollte optimistisch in die Zukunft schauen.", answer: "a — Moderatorin" },
        ],
      },
      {
        type: "text",
