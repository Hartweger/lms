...
const LESSON_SECTIONS: Record<number, { sections: unknown[] }> = {
  // ────────────────────────────────────────────────────────────────
  // "Rotkäppchen und das Präteritum" — order_index 1 in DB
  // ────────────────────────────────────────────────────────────────
  1: {
    sections: [
      {
  ...
  // ────────────────────────────────────────────────────────────────
  // "Als oder wenn" — order_index 2 in DB
  // ────────────────────────────────────────────────────────────────
  2: {
    sections: [
      {
  ...
  // ────────────────────────────────────────────────────────────────
  // "Schreiben B1 — E-Mail an einen Freund" — order_index 4 in DB
  // ────────────────────────────────────────────────────────────────
  4: {
    sections: [
      {
