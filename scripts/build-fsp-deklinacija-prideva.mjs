...
- u množini sa: wenige, einige` },
  ...
  { type: "spoiler", title: "Aufgabe 3 - klikni za rešenje", items: [
    { question: "(der, Akk., m.) verletzt- Arm", answer: "den verletzten Arm - Akkusativ maskulin, određeni član → nastavak -en." },
    { question: "(ein, Akk., f.) verletzt- Hand", answer: "eine verletzte Hand - Akkusativ feminin, neodređeni član → nastavak -e." },
    { question: "(das, Akk., n.) verletzt- Bein", answer: "das verletzte Bein - Akkusativ neutrum, određeni član → nastavak -e." },
    { question: "(ein, Dat., n.) verletzt- Bein", answer: "einem verletzten Bein - Dativ, neodređeni član → nastavak -en." },
    { question: "(-, Akk., Pl.) verletzt- Arme", answer: "verletzte Arme - Akkusativ množina bez člana (jaka deklinacija) → nastavak -e." },
  ] },
