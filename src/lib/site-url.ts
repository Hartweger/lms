...
// Default je trenutni produkcioni domen (kurs.hartweger.rs). Na FLIP-DAN se menja
// SAMO Vercel env `NEXT_PUBLIC_SITE_URL` na "https://www.hartweger.rs" — bez izmena koda.
//
...
export const SITE_URL = raw && raw.length > 0 ? raw.replace(/\/+$/, "") : "https://kurs.hartweger.rs";
