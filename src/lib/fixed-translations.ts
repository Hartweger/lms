...
export const FIXED_TRANSLATIONS: Record<string, FixedSentence[]> = {
  ...
  // ── C1.1 tematske lekcije (svaka rečenica cilja gramatiku svoje lekcije) ──
  "Freundschaft - Was bedeutet das eigentlich?": [
    { sr: "Pod uslovom da se obe strane trude, prijateljstvo preživi i veliku daljinu.", de: "Vorausgesetzt, dass sich beide Seiten bemühen, übersteht eine Freundschaft auch große Entfernungen." },
    { sr: "Da nisam tada reagovala, verovatno bismo se odavno izgubili iz vida.", de: "Hätte ich damals nicht reagiert, hätten wir uns wahrscheinlich längst aus den Augen verloren." },
    { sr: "U slučaju da se ne javi do petka, poslaću mu poruku.", de: "Falls er sich bis Freitag nicht meldet, schreibe ich ihm eine Nachricht." },
    { sr: "To je ipak bilo malo previše, zar ne?", de: "Das war doch etwas zu viel, oder?" },
    { sr: "Spremnost na kompromis se u prijateljstvu često potcenjuje.", de: "Die Kompromissbereitschaft wird in Freundschaften häufig unterschätzt." },
    { sr: "Sve dok se poverenje ne izgubi, svađa ne mora ništa da znači.", de: "Solange das Vertrauen nicht verloren geht, muss ein Streit nichts bedeuten." },
  ],
  "Selbstbilder - Hoch- und Tiefstapeln": [
    { sr: "Ljudi koji stalno umanjuju svoje sposobnosti deluju skromno, ali sebi štete.", de: "Menschen, die ihre Fähigkeiten ständig kleinreden, wirken bescheiden, schaden sich aber selbst." },
    { sr: "Njena staloženost me je impresionirala više od svake diplome.", de: "Ihre Gelassenheit hat mich mehr beeindruckt als jedes Zeugnis." },
    { sr: "Preterana ambicija često prikriva duboku nesigurnost.", de: "Übertriebener Ehrgeiz verbirgt oft eine tiefe Unsicherheit." },
    { sr: "Na razgovoru za posao se očekuje realna slika o sebi.", de: "Im Vorstellungsgespräch wird ein realistisches Selbstbild erwartet." },
    { sr: "Kod nekih kolega cenim njihovu pouzdanost.", de: "An manchen Kollegen schätze ich ihre Zuverlässigkeit." },
    { sr: "Ko se stalno hvali, pre ili kasnije bude raskrinkan.", de: "Wer ständig hochstapelt, wird früher oder später entlarvt." },
  ],
  "Mehrsprachigkeit - Wie wir Sprachen (er)leben": [
    { sr: "Budući da je odrasla dvojezično, oba jezika joj deluju prirodno.", de: "Da sie zweisprachig aufgewachsen ist, fühlen sich beide Sprachen für sie natürlich an." },
    { sr: "Deca ne uče brže samo zato što su mlađa.", de: "Kinder lernen nicht allein deshalb schneller, weil sie jünger sind." },
    { sr: "Zbog nedostatka prilika za vežbanje mnogi zaboravljaju maternji jezik.", de: "Aufgrund fehlender Gelegenheiten zum Üben verlernen viele ihre Erstsprache." },
    { sr: "Znakovni jezik je u više zemalja priznat kao ravnopravan jezik.", de: "Die Gebärdensprache ist in mehreren Ländern als gleichwertige Sprache anerkannt." },
    { sr: "Na drugom jeziku često delujem drugačije nego na svom.", de: "In einer anderen Sprache komme ich oft anders rüber als in meiner eigenen." },
    { sr: "Višejezičnost je prednost, utoliko pre što otvara i nove načine razmišljanja.", de: "Mehrsprachigkeit ist ein Vorteil, zumal sie auch neue Denkweisen eröffnet." },
  ],
  "Mobilität - Eine Frage der Gerechtigkeit?": [
    { sr: "Gradonačelnica je rekla da će linija biti zadržana.", de: "Die Bürgermeisterin sagte, die Linie werde beibehalten." },
    { sr: "U izveštaju stoji da su troškovi znatno porasli.", de: "Im Bericht heißt es, die Kosten seien deutlich gestiegen." },
    { sr: "Grad je doneo odluku da proširi biciklističku mrežu.", de: "Die Stadt hat die Entscheidung getroffen, das Radwegenetz auszubauen." },
    { sr: "Za ljude sa sela loša povezanost predstavlja stvarnu prepreku.", de: "Für Menschen auf dem Land stellt die schlechte Verkehrsanbindung ein echtes Hindernis dar." },
    { sr: "Kritikovao je da se pristupačnost i dalje smatra dodatkom.", de: "Er kritisierte, dass Barrierefreiheit noch immer als Zusatz betrachtet werde." },
    { sr: "O ograničenju brzine se godinama vodi rasprava.", de: "Über die Geschwindigkeitsbegrenzung wird seit Jahren eine Debatte geführt." },
  ],
  "Körper und Geist - Mit Schwung in den Alltag!": [
    { sr: "Posle buđenja preporučuje se kratko istezanje.", de: "Nach dem Aufwachen empfiehlt sich ein kurzes Dehnen." },
    { sr: "Redovnim vežbanjem se dugoročno poboljšava koncentracija.", de: "Durch regelmäßige Bewegung verbessert sich langfristig die Konzentration." },
    { sr: "Uprkos velikom opterećenju na poslu, ona nalazi vreme za sport.", de: "Trotz der hohen Belastung im Beruf findet sie Zeit für Sport." },
    { sr: "Nedostatak sna dovodi do pada radne sposobnosti.", de: "Schlafmangel führt zu einem Rückgang der Leistungsfähigkeit." },
    { sr: "Pri odabiru vežbi treba voditi računa o sopstvenim granicama.", de: "Bei der Auswahl der Übungen sind die eigenen Grenzen zu berücksichtigen." },
    { sr: "Zbog jednostranog sedenja dolazi do bolova u leđima.", de: "Wegen einseitigen Sitzens kommt es zu Rückenschmerzen." },
  ],
  "Ausbildungswege - Offene Türen und gläserne Decken": [
    { sr: "Iako je bila najbolja u generaciji, dugo nije dobila unapređenje.", de: "Obwohl sie die Beste ihres Jahrgangs war, wurde sie lange nicht befördert." },
    { sr: "Uprkos brojnim programima, nevidljiva prepreka i dalje postoji.", de: "Trotz zahlreicher Programme besteht die gläserne Decke nach wie vor." },
    { sr: "Njemu je taj korak pao teško, ali ga nije zažalio.", de: "Ihm ist dieser Schritt schwergefallen, bereut hat er ihn jedoch nicht." },
    { sr: "Odluka je pala tek posle dugog razgovora.", de: "Die Entscheidung ist erst nach einem langen Gespräch gefallen." },
    { sr: "Ma koliko se trudila, predrasude su ostale.", de: "So sehr sie sich auch bemühte, die Vorurteile blieben bestehen." },
    { sr: "Stručna obuka se često potcenjuje, mada otvara mnoga vrata.", de: "Die duale Ausbildung wird oft unterschätzt, obgleich sie viele Türen öffnet." },
  ],
  "Nachhaltigkeit - Alles im grünen Bereich": [
    { sr: "Mnoga preduzeća su ponosna na svoju klimatsku bilansu.", de: "Viele Unternehmen sind stolz auf ihre Klimabilanz." },
    { sr: "Ona je uverena u to da promena počinje od svakodnevice.", de: "Sie ist davon überzeugt, dass die Wende im Alltag beginnt." },
    { sr: "Potrošači su sve svesniji posledica svoje kupovine.", de: "Die Verbraucher sind sich der Folgen ihres Konsums immer bewusster." },
    { sr: "Ovaj proizvod je štetan po životnu sredinu, iako se reklamira kao zelen.", de: "Dieses Produkt ist schädlich für die Umwelt, obwohl es als grün beworben wird." },
    { sr: "Zavisimo od jasnih pravila, ne od dobrovoljnih obećanja.", de: "Wir sind auf klare Regeln angewiesen, nicht auf freiwillige Versprechen." },
    { sr: "Ko je zainteresovan za održivost, ne sme da nasedne na lepe reči.", de: "Wer an Nachhaltigkeit interessiert ist, darf schönen Worten nicht aufsitzen." },
  ],
  "Altern - Ewig leben?": [
    { sr: "Dok jedni sanjaju o dugovečnosti, drugi se plaše posledica.", de: "Während die einen von Langlebigkeit träumen, fürchten andere die Folgen." },
    { sr: "Medicina napreduje, društvo se, nasuprot tome, menja sporo.", de: "Die Medizin macht Fortschritte, die Gesellschaft hingegen verändert sich langsam." },
    { sr: "Starost sama po sebi nije bolest, mada se tako često predstavlja.", de: "Das Alter ist an sich keine Krankheit, auch wenn es oft so dargestellt wird." },
    { sr: "Nije reč o tome da se živi duže, nego da se živi bolje.", de: "Es geht nicht darum, länger zu leben, sondern besser zu leben." },
    { sr: "Penzioni sistem će morati da se prilagodi, hteli mi to ili ne.", de: "Das Rentensystem wird sich anpassen müssen, ob wir wollen oder nicht." },
    { sr: "Mnogi stariji su aktivniji nego što ih javnost prikazuje.", de: "Viele ältere Menschen sind aktiver, als die Öffentlichkeit sie darstellt." },
  ],
  "Licht - Von allen Seiten beleuchtet": [
    { sr: "Zbog prekomernog osvetljenja gradova pati noćni život insekata.", de: "Durch die übermäßige Beleuchtung der Städte leidet das nächtliche Insektenleben." },
    { sr: "Nedostatak dnevne svetlosti utiče na raspoloženje.", de: "Der Mangel an Tageslicht wirkt sich auf die Stimmung aus." },
    { sr: "Prilikom projektovanja zgrada vodi se računa o upadu svetlosti.", de: "Bei der Planung von Gebäuden wird der Lichteinfall berücksichtigt." },
    { sr: "Uvođenje toplijih lampi dovelo je do vidnog poboljšanja.", de: "Die Einführung wärmerer Leuchten hat zu einer deutlichen Verbesserung geführt." },
    { sr: "Svetlosno zagađenje je dugo bilo zanemarivano.", de: "Die Lichtverschmutzung wurde lange vernachlässigt." },
    { sr: "Posle isključivanja rasvete zvezde su ponovo bile vidljive.", de: "Nach dem Abschalten der Beleuchtung waren die Sterne wieder sichtbar." },
  ],
  "Fehlerkultur - Entschuldigung!": [
    { sr: "Time što je greška odmah prijavljena, sprečena je veća šteta.", de: "Dadurch, dass der Fehler sofort gemeldet wurde, konnte größerer Schaden verhindert werden." },
    { sr: "Ne možeš da naučiš iz greške a da je prethodno ne priznaš.", de: "Man kann aus einem Fehler nicht lernen, ohne ihn zuvor einzugestehen." },
    { sr: "Umesto da traži krivca, tim analizira uzroke.", de: "Anstatt einen Schuldigen zu suchen, analysiert das Team die Ursachen." },
    { sr: "Izvinjenje deluje samo ako je iskreno.", de: "Eine Entschuldigung wirkt nur dann, wenn sie aufrichtig ist." },
    { sr: "Tako što se otvoreno govori o greškama, gradi se poverenje.", de: "Indem offen über Fehler gesprochen wird, entsteht Vertrauen." },
    { sr: "Bez jasnih pravila zaposleni ćute o problemima.", de: "Ohne klare Regeln schweigen die Mitarbeitenden über Probleme." },
  ],
  "Wendepunkte - Geschichte und Geschichten": [
    { sr: "Da su tada drugačije odlučili, istorija bi možda tekla drugim tokom.", de: "Hätten sie damals anders entschieden, wäre die Geschichte vielleicht anders verlaufen." },
    { sr: "Trebalo je da se ranije reaguje na upozorenja.", de: "Man hätte früher auf die Warnungen reagieren müssen." },
    { sr: "Ona je mogla da ostane, ali je svesno izabrala odlazak.", de: "Sie hätte bleiben können, hat sich aber bewusst für den Weggang entschieden." },
    { sr: "Taj datum se i danas smatra prekretnicom.", de: "Dieses Datum gilt bis heute als Wendepunkt." },
    { sr: "Ne bismo smeli da zaboravimo koliko je taj korak bio rizičan.", de: "Wir hätten nicht vergessen dürfen, wie riskant dieser Schritt war." },
    { sr: "Duboko potresen, opisao je te dane u svojim memoarima.", de: "Tief erschüttert beschrieb er diese Tage in seinen Memoiren." },
  ],
  "Datenlücken - Alle Menschen im Blick": [
    { sr: "Podaci su prikupljani samo na muškarcima, tako da su rezultati iskrivljeni.", de: "Die Daten wurden nur an Männern erhoben, sodass die Ergebnisse verzerrt sind." },
    { sr: "Rupe u podacima su toliko velike da se čitave grupe ne vide.", de: "Die Datenlücken sind so groß, dass ganze Gruppen unsichtbar bleiben." },
    { sr: "Sigurnosni pojas je bio testiran na prosečnom muškom telu i zato manje štiti žene.", de: "Der Sicherheitsgurt wurde am durchschnittlichen männlichen Körper getestet und schützt Frauen folglich weniger." },
    { sr: "Algoritam je učio iz pristrasnih podataka, usled čega ponavlja predrasude.", de: "Der Algorithmus hat aus voreingenommenen Daten gelernt, weshalb er Vorurteile wiederholt." },
    { sr: "Razvoj proizvoda mora obuhvatiti sve korisnike, inače nastaju skupe greške.", de: "Die Produktentwicklung muss alle Nutzenden einbeziehen, sonst entstehen teure Fehler." },
    { sr: "Nedostajali su podaci o starijim osobama, te je studija morala biti ponovljena.", de: "Es fehlten Daten zu älteren Menschen, sodass die Studie wiederholt werden musste." },
  ],
};
