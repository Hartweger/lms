    ...
    <footer className="bg-[#1a2332] text-gray-300 mt-auto">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Logo + tagline */}
          <div>
            <img src="/logo-white.svg" alt="Hartweger" className="h-8 mb-4" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none' }} />
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.youtube.com/channel/UCa_7vX8_EtWNUbjA9SqqMwQ" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="YouTube">
