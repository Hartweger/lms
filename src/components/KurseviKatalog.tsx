...
const tabs: TabConfig[] = [
  {
    ...
    defaultLevel: "a1",
    cards: [
      { badges: [{ label: "A1.1", color: "a1" }], title: "Grupni kurs A1.1", meta: "3–6 polaznika", desc: "Za apsolutne početnike. Osnove komunikacije, pozdrave i svakodnevne fraze.", price: "19.600 din", priceEur: "≈ 168€", href: "/grupni-kursevi", cta: "Prijavi se", level: "a1" },
      { badges: [{ label: "A1.2", color: "a1" }], title: "Grupni kurs A1.2", meta: "3–6 polaznika", desc: "Nastavak A1.1. Proširivanje rečnika i uvod u gramatičke strukture.", price: "19.600 din", priceEur: "≈ 168€", href: "/grupni-kursevi", cta: "Prijavi se", level: "a1" },
      { badges: [{ label: "A2.1", color: "a2" }], title: "Grupni kurs A2.1", meta: "3–6 polaznika", desc: "Elementarni nivo. Razgovarate o sebi, porodici i svakodnevnim situacijama.", price: "19.600 din", priceEur: "≈ 168€", href: "/grupni-kursevi", cta: "Prijavi se", level: "a2" },
      { badges: [{ label: "A2.2", color: "a2" }], title: "Grupni kurs A2.2", meta: "3–6 polaznika", desc: "Nastavak A2.1. Gramatika, konverzacija i svakodnevne situacije na višem nivou.", price: "19.600 din", priceEur: "≈ 168€", href: "/grupni-kursevi", cta: "Prijavi se", level: "a2" },
      { badges: [{ label: "B1.1", color: "b1" }], title: "Grupni kurs B1.1", meta: "3–6 polaznika", desc: "Srednji nivo. Razumete glavne teme i slobodno izražavate mišljenje.", price: "19.600 din", priceEur: "≈ 168€", href: "/grupni-kursevi", cta: "Prijavi se", level: "b1" },
      { badges: [{ label: "B1.2", color: "b1" }], title: "Grupni kurs B1.2", meta: "3–6 polaznika", desc: "Nastavak B1.1. Kompleksnija gramatika i bogaćenje vokabulara.", price: "19.600 din", priceEur: "≈ 168€", href: "/grupni-kursevi", cta: "Prijavi se", level: "b1" },
      { badges: [{ label: "B2.1", color: "b2" }], title: "Grupni kurs B2.1", meta: "3–6 polaznika", desc: "Više-srednji nivo. Tečna komunikacija, složene strukture i apstraktne teme.", price: "21.200 din", priceEur: "≈ 181€", href: "/grupni-kursevi", cta: "Prijavi se", level: "b2" },
      { badges: [{ label: "B2.2", color: "b2" }], title: "Grupni kurs B2.2", meta: "3–6 polaznika", desc: "Nastavak B2.1. Priprema za Goethe B2 ispit i napredna konverzacija.", price: "21.200 din", priceEur: "≈ 181€", href: "/grupni-kursevi", cta: "Prijavi se", level: "b2" },
      { badges: [{ label: "C1.1", color: "c1" }], title: "Grupni kurs C1.1", meta: "3–6 polaznika", desc: "Napredni nivo. Poslovni i akademski nemački, priprema za C1 ispit.", price: "21.200 din", priceEur: "≈ 181€", href: "/grupni-kursevi", cta: "Prijavi se", level: "c1" },
      { badges: [{ label: "C1.2", color: "c1" }], title: "Grupni kurs C1.2", meta: "3–6 polaznika", desc: "Nastavak C1.1. Kompleksne strukture i kompletna priprema za Goethe C1 ispit.", price: "21.200 din", priceEur: "≈ 181€", href: "/grupni-kursevi", cta: "Prijavi se", level: "c1" },
    ],
  },
  {
    id: "video",
    ...
    defaultLevel: "a1",
    cards: [
      { badges: [{ label: "Video", color: "video" }, { label: "A1", color: "a1" }], title: "VIDEO kurs A1", meta: "Vaš tempo · Pristup godinu dana", desc: "Kompletan A1 nivo u video lekcijama. Gramatika, izgovor, vežbanja — pratite sopstvenim tempom.", price: "11.600 din", priceEur: "≈ 99€", href: "/kursevi/video-kurs-a1", cta: "Kupi kurs", level: "a1" },
      { badges: [{ label: "Video", color: "video" }, { label: "A2", color: "a2" }], title: "VIDEO kurs A2", meta: "Vaš tempo · Pristup godinu dana", desc: "Nastavak A1. Gramatika i vokabular za svakodnevne situacije — bez vremenskog pritiska.", price: "11.600 din", priceEur: "≈ 99€", href: "/kursevi/video-kurs-a2", cta: "Kupi kurs", level: "a2" },
      { badges: [{ label: "Video", color: "video" }, { label: "B1", color: "b1" }], title: "VIDEO kurs B1", meta: "Vaš tempo · Pristup godinu dana", desc: "Srednji nivo u vašem tempu. Priprema za B1 ispit ili rad u nemačkom govornom području.", price: "11.600 din", priceEur: "≈ 99€", href: "/kursevi/video-kurs-b1", cta: "Kupi kurs", level: "b1" },
      { badges: [{ label: "Paket", color: "paket" }, { label: "– 12%", color: "sale" }], title: "Video paket A1 + A2", meta: "2 kursa u paketu", desc: "A1 i A2 video kurs zajedno po specijalnoj ceni. Idealno za početnike koji žele brži napredak.", oldPrice: "23.200 din", salePrice: "20.475 din", salePriceEur: "≈ 175€", saveAmount: "Uštedite 2.725 din", price: "", priceEur: "", href: "/kursevi/paket-a1-a2", cta: "Kupi paket", level: "paket" },
      ...
      { badges: [{ label: "Masterclass", color: "master" }, { label: "Goethe B2", color: "b2" }], title: "VIDEO: Položi Goethe B2", meta: "Sa Natašom i Ankom", desc: "Ciljana priprema za Goethe B2 ispit. Strategije, tipovi zadataka i vežbanje svih delova testa.", price: "2.880 din", priceEur: "≈ 25€", href: "/kursevi/polozi-goethe-b2", cta: "Kupi", level: "masterclass" },
      ...
      { badges: [{ label: "Gramatika", color: "gram" }, { label: "A2–B1", color: "b1" }], title: "VIDEO + E-book Gramatika A2–B1", meta: "Vaš tempo · Uključen e-book", desc: "90 minuta predavanja prof. Nataše Hartweger + e-book sa svim objašnjenjima i vežbama na platformi. Kompletna gramatika od A2 do B1.", price: "4.680 din", priceEur: "≈ 40€", href: "/kursevi/gramatika-a2-b1", cta: "Kupi", level: "gramatika" },
      { badges: [{ label: "Specijalni", color: "spec" }], title: "Kurs za mame i trudnice", meta: "Prilagođen mamama", desc: "Kurs nemačkog posebno dizajniran za mame i trudnice koje se pripremaju za život u Nemačkoj ili Austriji.", price: "6.435 din", priceEur: "≈ 55€", href: "/kursevi/kurs-za-mame-i-trudnice", cta: "Kupi", level: "specijalni", accent: true },
  ...
  },
  {
    ...
    defaultLevel: "a1",
    cards: [
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "A1.1", color: "a1" }], title: "Individualni kurs A1.1", meta: "Termin po dogovoru", desc: "Potpuno prilagođen vama. Vaš tempo, vaši ciljevi — idealno za zaposlene bez fiksnog rasporeda.", price: "od 23.000 din", priceEur: "≈ od 197€", href: "/individualni-kursevi", cta: "Zakaži", level: "a1" },
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "A1.2", color: "a1" }], title: "Individualni kurs A1.2", meta: "Termin po dogovoru", desc: "Nastavak A1.1 u individualnom formatu. Gramatika i konverzacija prilagođeni vašem napretku.", price: "od 23.000 din", priceEur: "≈ od 197€", href: "/individualni-kursevi", cta: "Zakaži", level: "a1" },
      { badges: [{ label: "Paket", color: "paket" }, { label: "A1 komplet", color: "a1" }], title: "Paket A1 individualni (A1.1 + A1.2)", meta: "Oba A1 nivoa", desc: "A1.1 i A1.2 individualno u paketu. Kompletno savladajte A1 nivo uz personalnu pažnju predavača.", price: "46.000 din", priceEur: "≈ 393€", href: "/individualni-kursevi", cta: "Zakaži", level: "a1" },
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "A2.1", color: "a2" }], title: "Individualni kurs A2.1", meta: "Termin po dogovoru", desc: "Elementarni nivo jedan na jedan. Brži napredak jer je sve fokusirano samo na vas.", price: "od 33.000 din", priceEur: "≈ od 282€", href: "/individualni-kursevi", cta: "Zakaži", level: "a2" },
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "A2.2", color: "a2" }], title: "Individualni kurs A2.2", meta: "Termin po dogovoru", desc: "Nastavak A2.1. Konverzacija, gramatika i vežbanja po vašim potrebama.", price: "od 33.000 din", priceEur: "≈ od 282€", href: "/individualni-kursevi", cta: "Zakaži", level: "a2" },
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "B1.1", color: "b1" }], title: "Individualni kurs B1.1", meta: "Termin po dogovoru", desc: "Srednji nivo, potpuno prilagođen. Fokus na govoru i razumevanju autentičnih materijala.", price: "od 35.000 din", priceEur: "≈ od 299€", href: "/individualni-kursevi", cta: "Zakaži", level: "b1" },
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "B1.2", color: "b1" }], title: "Individualni kurs B1.2", meta: "Termin po dogovoru", desc: "Nastavak B1.1. Kompleksnija gramatika i priprema za B1 ispit u individualnom formatu.", price: "od 35.000 din", priceEur: "≈ od 299€", href: "/individualni-kursevi", cta: "Zakaži", level: "b1" },
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "B2.1", color: "b2" }], title: "Individualni kurs B2.1", meta: "Termin po dogovoru", desc: "Više-srednji nivo jedan na jedan. Tečna komunikacija, kompleksne strukture i apstraktne teme.", price: "od 37.000 din", priceEur: "≈ od 316€", href: "/individualni-kursevi", cta: "Zakaži", level: "b2" },
      { badges: [{ label: "Mesečni paket", color: "paket" }], title: "Individualni mesečni paketi", meta: "Fleksibilno · Nema sertifikata", desc: "Za poseban zahtev mimo nivoa. Plaćate mesečno i prilagođavate tempo i sadržaj prema potrebama.", price: "od 14.000 din", priceEur: "≈ od 120€", href: "/individualni-kursevi", cta: "Zakaži", level: "paket" },
      { badges: [{ label: "Specijalni", color: "spec" }, { label: "FIDE · 1 na 1", color: "fide" }], title: "Individualni: Položi FIDE", meta: "Boravišna dozvola — Švajcarska", desc: "Individualna priprema za FIDE ispit. Personalizovan program za dobijanje švajcarske boravišne dozvole.", price: "od 23.000 din", priceEur: "≈ od 197€", href: "/individualni-kursevi", cta: "Zakaži", level: "spec" },
      { badges: [{ label: "Specijalni", color: "spec" }, { label: "FSP · Lekari", color: "fide" }], title: "FSP individualni – za lekare", meta: "Medicinski nemački · 1 na 1", desc: "Individualna priprema za FSP stručni ispit za lekare koji žele da rade u Nemačkoj.", price: "od 23.000 din", priceEur: "≈ od 197€", href: "/individualni-kursevi", cta: "Zakaži", level: "spec" },
    ],
  },
  {
    id: "besplatno",
