...
const tabs: TabConfig[] = [
  ...
  },
  {
    ...
    defaultLevel: "a1",
    cards: [
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "A1.1", color: "a1" }], title: "Individualni kurs A1.1", meta: "Termin po dogovoru", desc: "Potpuno prilagođen vama. Vaš tempo, vaši ciljevi — idealno za zaposlene bez fiksnog rasporeda.", price: "od 23.000 din", priceEur: "≈ od 197€", href: "/kursevi/individualni-kurs-nemackog-jezika-a11", cta: "Zakaži", level: "a1" },
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "A1.2", color: "a1" }], title: "Individualni kurs A1.2", meta: "Termin po dogovoru", desc: "Nastavak A1.1 u individualnom formatu. Gramatika i konverzacija prilagođeni vašem napretku.", price: "od 23.000 din", priceEur: "≈ od 197€", href: "/kursevi/individualni-kurs-nemackog-jezika-a1-2", cta: "Zakaži", level: "a1" },
      ...
      { badges: [{ label: "1 na 1", color: "ind" }, { label: "A2.2", color: "a2" }], title: "Individualni kurs A2.2", meta: "Termin po dogovoru", desc: "Nastavak A2.1. Konverzacija, gramatika i vežbanja po vašim potrebama.", price: "od 33.000 din", priceEur: "≈ od 282€", href: "/kursevi/individualni-kurs-nemackog-jezika-a2-2", cta: "Zakaži", level: "a2" },
