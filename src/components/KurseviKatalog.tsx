...
const tabs: TabConfig[] = [
  {
    ...
    defaultLevel: "a1",
    cards: [
      { badges: [{ label: "A1.1", color: "a1" }], title: "Grupni kurs A1.1", meta: "3-6 polaznika", desc: "Za apsolutne početnike. Osnove komunikacije, pozdrave i svakodnevne fraze.", price: "19.600 RSD", priceEur: "≈ 168€", href: "/kursevi/grupni-kurs-nemackog-jezika-a1-1", cta: "Prijavi se", level: "a1" },
      { badges: [{ label: "A1.2", color: "a1" }], title: "Grupni kurs A1.2", meta: "3-6 polaznika", desc: "Nastavak A1.1. Proširivanje rečnika i uvod u gramatičke strukture.", price: "19.600 RSD", priceEur: "≈ 168€", href: "/kursevi/grupni-kurs-nemackog-jezika-a1-2-2", cta: "Prijavi se", level: "a1" },
      { badges: [{ label: "A2.1", color: "a2" }], title: "Grupni kurs A2.1", meta: "3-6 polaznika", desc: "Elementarni nivo. Razgovarate o sebi, porodici i svakodnevnim situacijama.", price: "19.600 RSD", priceEur: "≈ 168€", href: "/kursevi/grupni-kurs-nemackog-jezika-a2", cta: "Prijavi se", level: "a2" },
      { badges: [{ label: "A2.2", color: "a2" }], title: "Grupni kurs A2.2", meta: "3-6 polaznika", desc: "Nastavak A2.1. Gramatika, konverzacija i svakodnevne situacije na višem nivou.", price: "19.600 RSD", priceEur: "≈ 168€", href: "/kursevi/grupni-kurs-nemackog-jezika-a2-2", cta: "Prijavi se", level: "a2" },
      { badges: [{ label: "B1.1", color: "b1" }], title: "Grupni kurs B1.1", meta: "3-6 polaznika", desc: "Srednji nivo. Razumete glavne teme i slobodno izražavate mišljenje.", price: "19.600 RSD", priceEur: "≈ 168€", href: "/kursevi/grupni-kurs-nemackog-jezika-b1-1-2", cta: "Prijavi se", level: "b1" },
      { badges: [{ label: "B1.2", color: "b1" }], title: "Grupni kurs B1.2", meta: "3-6 polaznika", desc: "Nastavak B1.1. Kompleksnija gramatika i bogaćenje vokabulara.", price: "19.600 RSD", priceEur: "≈ 168€", href: "/kursevi/grupni-kurs-nemackog-b1-2", cta: "Prijavi se", level: "b1" },
      { badges: [{ label: "B2.1", color: "b2" }], title: "Grupni kurs B2.1", meta: "3-6 polaznika", desc: "Više-srednji nivo. Tečna komunikacija, složene strukture i apstraktne teme.", price: "21.200 RSD", priceEur: "≈ 181€", href: "/kursevi/grupni-kurs-b2-1", cta: "Prijavi se", level: "b2" },
      { badges: [{ label: "B2.2", color: "b2" }], title: "Grupni kurs B2.2", meta: "3-6 polaznika", desc: "Nastavak B2.1. Priprema za Goethe B2 ispit i napredna konverzacija.", price: "21.200 RSD", priceEur: "≈ 181€", href: "/kursevi/grupni-kurs-b2-2", cta: "Prijavi se", level: "b2" },
      { badges: [{ label: "C1.1", color: "c1" }], title: "Grupni kurs C1.1", meta: "3-6 polaznika", desc: "Napredni nivo. Poslovni i akademski nemački, priprema za C1 ispit.", price: "21.200 RSD", priceEur: "≈ 181€", href: "/kursevi/grupni-kurs-c1-1", cta: "Prijavi se", level: "c1" },
      { badges: [{ label: "C1.2", color: "c1" }], title: "Grupni kurs C1.2", meta: "3-6 polaznika", desc: "Nastavak C1.1. Kompleksne strukture i kompletna priprema za Goethe C1 ispit.", price: "21.200 RSD", priceEur: "≈ 181€", href: "/kursevi/grupni-kurs-c1-2", cta: "Prijavi se", level: "c1" },
    ],
  },
  {
    id: "konverzacijski",
  ...
  },
  {
    ...
    defaultLevel: "a1",
    cards: [
      { badges: [{ label: "Video", color: "video" }, { label: "A1", color: "a1" }], title: "VIDEO kurs A1", meta: "Tvoj tempo · Pristup godinu dana", desc: "Kompletan A1 nivo u video lekcijama. Gramatika, izgovor, vežbanja - prati sopstvenim tempom.", price: "11.600 RSD", priceEur: "≈ 99€", href: "/kursevi/video-kurs-a1", cta: "Kupi kurs", level: "a1" },
      { badges: [{ label: "Video", color: "video" }, { label: "A2", color: "a2" }], title: "VIDEO kurs A2", meta: "Tvoj tempo · Pristup godinu dana", desc: "Nastavak A1. Gramatika i vokabular za svakodnevne situacije - bez vremenskog pritiska.", price: "11.600 RSD", priceEur: "≈ 99€", href: "/kursevi/video-kurs-a2", cta: "Kupi kurs", level: "a2" },
      ...
      { badges: [{ label: "Masterclass", color: "master" }, { label: "Goethe B2", color: "b2" }], title: "VIDEO: Položi Goethe B2", meta: "Sa Natašom i Ankom", desc: "Ciljana priprema za Goethe B2 ispit. Strategije, tipovi zadataka i vežbanje svih delova testa.", price: "2.880 RSD", priceEur: "≈ 25€", href: "/kurs/polozi-goethe-b2", cta: "Kupi", level: "masterclass" },
