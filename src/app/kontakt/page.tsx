...
export const metadata: Metadata = {
  ...
  description: "Imaš pitanje o kursevima nemačkog, plaćanju ili pristupu platformi? Piši nam - tu smo za tebe.",
  openGraph: {
    title: "Kontakt - Hartweger škola nemačkog jezika",
    description: "Imaš pitanje o kursevima nemačkog, plaćanju ili pristupu platformi? Piši nam - tu smo za tebe.",
      ...
      <section className="py-12 px-4">
        <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-[300px] flex-shrink-0 space-y-6">
            {/* EPM 2.1.4: korisnički servis ističe adresu i e-mail; telefon uklonjen
                na Natašin zahtev 24.07.2026 (kontakt ide preko info@ i forme). */}
