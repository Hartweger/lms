        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              { q: "Kod mesečnog plaćanja - mogu li da otvorim ceo nivo unapred?", a: "Ne. Nivoi se otvaraju po rasporedu i ne mogu se ubrzati: A1.1 odmah, A1.2 uz 2. naplatu, A2.1 uz 4, A2.2 uz 5, B1.1 uz 7, B1.2 uz 8. Meseci 3, 6 i 9-12 nisu prazni - to je vreme za obnavljanje i završni ispit nivoa. Ako ti treba ceo nivo odmah, umesto paketa možeš da kupiš pojedinačan video kurs (A1, A2 ili B1) - plaćaš ga odjednom i ceo nivo ti je otvoren istog trenutka." },
              { q: "Šta dobijam odmah, a šta kasnije?", a: "Ako platiš odjednom, odmah imaš sva tri nivoa. Ako izabereš mesečno plaćanje, odmah ti se otvara A1.1 (51 lekcija i preko 60 vežbi), a ostali nivoi stižu redom kako teku naplate." },
