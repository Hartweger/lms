...
// Prvi spisak grupa stiže sa servera (page.tsx), pa nema učitavanja u efektu.
// fetchGroups ostaje za osvežavanje posle izmena.
export default function GrupeAdmin({ initial }: { initial: Group[] }) {
