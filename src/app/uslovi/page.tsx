...
// Uslovi korišćenja i politika privatnosti su OBJEDINJENI na ovoj stranici (zahtev
// Banca Intesa EPM kontrole, mejl 24.07.2026: kupac ne treba da otvara dva linka sa
// kojima se saglašava). /politika-privatnosti je trajni redirect na #politika-privatnosti.
export const metadata: Metadata = {
  title: "Opšti uslovi poslovanja i politika privatnosti - Hartweger",
  description: "Opšti uslovi korišćenja platforme Hartweger - uslovi kupovine, pristup kursevima, pravila korišćenja i politika privatnosti.",
  openGraph: {
    images: [{ url: "/og/share.png", width: 1200, height: 630, alt: "Hartweger - Škola nemačkog jezika" }],
    title: "Opšti uslovi poslovanja i politika privatnosti - Hartweger",
    description: "Opšti uslovi korišćenja platforme Hartweger i politika privatnosti.",
  },
};
