# Millionär - pitanja za A1.1 Modul 3 (NA PREGLEDU)

Gradivo: Essen, Preise, Im Restaurant. 15 glavnih + 5 rezervi. Tačan odgovor PODEBLJAN.

## Glavna pitanja (1-15)

**1.** "Doručak" na nemačkom je:
A) das Abendessen · B) **das Frühstück** · C) das Mittagessen · D) die Milch
_Objašnjenje: Abendessen je večera, Mittagessen je ručak._

**2.** Was ___ du zum Frühstück? (jesti)
A) esse · B) essen · C) **isst** · D) ist
_Objašnjenje: essen menja e u i: du isst. Pazi: "ist" je od glagola sein!_

**3.** Ich trinke Kaffee ___ Milch.
A) **mit** · B) und · C) für · D) aus
_Objašnjenje: kafa SA mlekom: mit Milch._

**4.** "Račun, molim!" na nemačkom je:
A) Die Karte, bitte! · B) Das Geld, bitte! · C) Der Preis, bitte! · D) **Die Rechnung, bitte!**
_Objašnjenje: die Rechnung = račun._

**5.** Er isst ___ Fleisch. (ne jede meso)
A) nicht · B) **kein** · C) keine · D) nein
_Objašnjenje: uz imenicu ide kein/keine, ne "nicht": kein Fleisch (das Fleisch)._

**6.** Was ___ ein Kilo Äpfel?
A) **kostet** · B) kosten · C) kostest · D) kauft
_Objašnjenje: Was kostet...? = koliko košta._

**7.** "To je preskupo." na nemačkom je:
A) Das ist sehr gut. · B) Das ist zu klein. · C) **Das ist zu teuer.** · D) Das ist zu spät.
_Objašnjenje: zu teuer = preskupo (zu + pridev = pre-)._

**8.** Ich brauche zwei ___. (hleba)
A) Brot · B) Brots · C) Broten · D) **Brote**
_Objašnjenje: množina od das Brot je die Brote._

**9.** ___ Sie Milch? (učtivo pitanje u prodavnici)
A) Hast · B) **Haben** · C) Habt · D) Habe
_Objašnjenje: persiranje: Haben Sie...?_

**10.** Das kostet drei Euro ___. (3,50 €)
...
_Objašnjenje: die Suppe je ženski rod: keine Suppe._
